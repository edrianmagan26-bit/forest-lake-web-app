...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/client/manage-lots', label: 'Manage Lots', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg> },
      { path: '/client/history', label: 'History', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
    ],
  },
  {
    label: 'Account',
          ...
          <nav className="flex-1 px-3 space-y-6 overflow-y-auto pt-2">
            {navSections.map(section => (
              <div key={section.label}>
                <p className="px-4 text-[10px] font-bold uppercase tracking-widest text-green-400/50 mb-2">{section.label}</p>
