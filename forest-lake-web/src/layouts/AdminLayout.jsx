        ...
        <div className="flex flex-col h-full">
                  ...
                  {section.items.map(item => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isActive && !compactSidebar && <span className="ml-auto w-1.5 h-1.5 bg-green-400 rounded-full"></span>}
                      </Link>
                    );
                  })}
                </div>
          ...
          {!compactSidebar ? (
            ...
            <div className="p-3 flex justify-center">
              <button onClick={handleLogout} title="Logout" className="w-10 h-10 rounded-xl text-red-300/80 hover:text-red-300 hover:bg-red-500/10 transition-all flex items-center justify-center">
